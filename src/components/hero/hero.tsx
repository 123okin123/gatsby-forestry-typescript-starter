          ...
          <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
              ...
              <div className="hidden md:block md:ml-10 md:pr-4">
                ...
                <a href="#" className="ml-8 font-medium text-primary-600 hover:text-primary-900 transition duration-150 ease-in-out">Log in</a>
              </div>
            </nav>
          </div>
          {/*
          ...
          <div className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
            <div className="rounded-lg shadow-md">
              <div className="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                ...
                <div>
                  <a href="#" className="block w-full px-5 py-3 text-center font-medium text-primary-600 bg-gray-50 hover:bg-gray-100 hover:text-primary-700 focus:outline-none focus:bg-gray-100 focus:text-primary-700 transition duration-150 ease-in-out" role="menuitem">
                    Log in
                  </a>
                </div>
              </div>
